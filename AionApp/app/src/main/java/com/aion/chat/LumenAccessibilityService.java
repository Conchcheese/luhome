...
public class LumenAccessibilityService extends AccessibilityService {
    ...
    public static boolean captureLatest(Context context, String app, String reason, boolean force, long delayMs, String httpBase) {
        ...
        LumenAccessibilityService svc = instance;
        if (svc == null) {
            return false;
        }
    ...
    public static boolean isEnabledInSettings(Context context) {
        try {
            ...
            ComponentName expected = new ComponentName(context, LumenAccessibilityService.class);
    ...
    private void uploadBase64(String b64, String app, String reason) {
        new Thread(() -> uploadBase64OnBackground(b64, app, reason), "LumenAccessibilityUpload").start();
    }
    ...
    private void postSkip(String reason, String app, boolean locked) {
        new Thread(() -> postSkipOnBackground(reason, app, locked), "LumenAccessibilitySkip").start();
    }
